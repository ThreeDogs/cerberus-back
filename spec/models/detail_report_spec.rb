...
describe DetailReport do
	it "Report OverView" do
		...
		@detail_report = @test_scenario.detail_reports.create(app_version: "1.0", status: 1, running_time: 660, device_key: "abcd", test_datetime: "14.MAR.05 17:00")
		...
		@detail_report.get_running_time.should == "660.0s (11:0)"
