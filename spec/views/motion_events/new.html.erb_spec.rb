...
describe "motion_events/new" do
  before(:each) do
    assign(:motion_event, stub_model(MotionEvent,
      :seq_id => 1,
      :sleep => 1,
  ...
  it "renders new motion_event form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", motion_events_path, "post" do
