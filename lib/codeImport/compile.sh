...
javac -d $1/temp2 -cp $1/temp2/libo.jar:$1/android-support-v4.jar:$1/android.jar:$1/robotium-solo-5.1.jar $3
# class 변환
...
javac -d $5 -cp $1/temp2/libo.jar:$1/android-support-v4.jar:$1/android.jar:$1/robotium-solo-5.1.jar CerberusRunner_$4.java
