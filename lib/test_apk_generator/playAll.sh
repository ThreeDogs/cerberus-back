...
java -classpath $3/asm-all-4.2.jar:$3/gson-2.2.4.jar:$3/test.jar org.cerberus.test.TestRunnerAsm $3 172.16.101.171 $8 $9 
echo "1-----------------------------------------------------------------"
...
testCodeClass=${10}
testFolder=$3/temp/newclz/org/cerberus/test
echo testFolder
java -classpath $3/tokencopy.jar filecopy.cerberus.Main $testFolder $testCodeClass  
